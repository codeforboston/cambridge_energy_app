...
tip_data = [
  ...
  { text: "Turn off the water while bruching your teeth!"},
  { text: "If it's yellow, let it mellow. Not flushing the toilet each time you use the bathroom could save a tremendous amount of water over time."},
  ...
  { text: "Install a motion sensor for your outdoor lights. Not only does it save energy from keeping those outdoor lights on and then forgetting about them, it also provides a safer outdoor experience."},
